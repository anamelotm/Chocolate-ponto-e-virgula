...
update produto set quantidade_estoque=quantidade_estoque -9 where id = 4;
update produto set quantidade_estoque=quantidade_estoque -11 where id = 5;
update produto set quantidade_estoque=quantidade_estoque -8 where id = 6;
update produto set quantidade_estoque=quantidade_estoque -12 where id = 7;
update produto set quantidade_estoque=quantidade_estoque -7 where id = 8;
update produto set quantidade_estoque=quantidade_estoque -11 where id = 9;
update produto set quantidade_estoque=quantidade_estoque -5 where id = 10;
update produto set quantidade_estoque=quantidade_estoque -15 where id = 11;
update produto set quantidade_estoque=quantidade_estoque -13 where id = 12;
update produto set quantidade_estoque=quantidade_estoque -15 where id = 13;
update produto set quantidade_estoque=quantidade_estoque -6 where id = 14;
